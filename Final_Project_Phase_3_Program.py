...
## print the number of data points predicted as class 4, while the correct class is 2
def error_24(df):
    return df.loc[(df['Class'] == 4) & (df['Predicted_Class'] == 2), ['Scn', 'Class', 'Predicted_Class']]


## print the number of data points predicted as class 2, while the correct class is 4  
def error_42(df):
    return df.loc[(df['Class'] == 2) & (df['Predicted_Class'] == 4), ['Scn', 'Class', 'Predicted_Class']]
